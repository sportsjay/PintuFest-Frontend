...
const images = [
  {
    url: 'https://wallpaperaccess.com/full/185940.jpg',
    title: 'Escape Room 1',
    width: '30%',
    link: '/game1',
  },
        ...
        <div className={classes.root}>
          <Grid container spacing={0}>
            <Grid item md={12} xs={12}>
              ...
              <div id="container">
                <img src="https://wallpaperaccess.com/full/2015320.jpg" width="100%" height="auto" /*object-fit="fill"*/ />
            ...
            <Grid>
              <Paper className={classes.paper} id="grid_color1" >
                <p className="subheading">Game's total duration</p>
            ...
            <Grid item md={6} xs={12}>
              <Paper className={classes.paper} id="grid_color2">
                <img src="https://wallpaperaccess.com/full/185940.jpg" width="auto" height="100%" />
              </Paper>
            </Grid>
            </div>
            <div id="column">
            <Grid item md={6} xs={12}>
              <Paper className={classes.paper} id="grid_color2">
                <img src="https://wallpaperaccess.com/full/185940.jpg" alt="game1_2" width="auto" height="100%" />
              </Paper>
            </Grid>
